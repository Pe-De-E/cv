    ...
    <div className="container clearfix">
          ...
          <div className="contact-info">
            ...
            <p>
              <a
                ...
                href="mailto:donsivler24@gmail.com"
              >
      ...
      <div className="main">
        ...
        <div className="experience-section">
          ...
          <div className="job">
            ...
            <div className="job-desc">
              ...
              <ul>
                {t("experience.job1.bullets", { returnObjects: true }).map(
                  (b, i) => (
                    <li key={i}>{b}</li>
                  ),
                )}
          ...
          <div className="job" style={{ marginTop: "25px" }}>
            ...
            <div className="job-desc">
              ...
              <ul>
                {t("experience.job2.bullets", { returnObjects: true }).map(
                  (b, i) => (
                    <li key={i}>{b}</li>
                  ),
                )}
          ...
          <div className="job" style={{ marginTop: "25px" }}>
            ...
            <div className="job-desc">
              ...
              <ul>
                {t("experience.job3.bullets", { returnObjects: true }).map(
                  (b, i) => (
                    <li key={i}>{b}</li>
                  ),
                )}
        ...
        <div className="skills-section">
          ...
          <p>
            <span className="skill-category">{t("tech.frontend")}</span>{" "}
            {t("tech.frontendValue")}
          </p>
          <p>
            <span className="skill-category">{t("tech.backend")}</span>{" "}
            {t("tech.backendValue")}
          </p>
          <p>
            <span className="skill-category">{t("tech.tools")}</span>{" "}
            {t("tech.toolsValue")}
          </p>
          <p>
            <span className="skill-category">{t("tech.approach")}</span>{" "}
            {t("tech.approachValue")}
          </p>
        </div>
